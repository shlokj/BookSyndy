...
public class BookMarkAdapter extends FirestoreRecyclerAdapter<Book,BookMarkAdapter.ViewHolder> {
     ...
     * @param options
     */
    protected BookMarkAdapter(@NonNull FirestoreRecyclerOptions<Book> options, BookMarkAdapter.OnBookSelectedListener listener, BookMarkAdapter.OnBookLongSelectedListener longListener) {
        super(options);
        mListener = listener;
